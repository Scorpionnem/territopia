...
execute on passengers if score @s unit.boatlevel matches 2.. at @e[tag=radius,tag=deep_ocean,tag=!fog] run summon item_display ~ ~ ~ {width:1.5f,Tags:["select_green","select","temp"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,1f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:paper",count:1,components:{"minecraft:custom_model_data":15}},brightness:{sky:15,block:15}}
