...
$execute at @n[tag=tile] run summon item_display ~ ~ ~ {Tags:["unit","$(name)","$(player)"],width:1.5f,item:{id:"minecraft:paper",count:1,components:{"minecraft:custom_model_data":8}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,1.2f,0f],scale:[1f,1f,1f]}}
...
$execute at @n[tag=tile] run summon item_display ~ ~ ~ {Tags:["playerhead"],transformation:{left_rotation:[0f,180f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,$(head)f,0f],scale:[1.4f,1.4f,1.4f]},item:{id:"minecraft:player_head",count:1}}
...
$scoreboard players add $(player) score 10
execute at @n[tag=village] run function general:xp {xp:10,offset:2.1}
