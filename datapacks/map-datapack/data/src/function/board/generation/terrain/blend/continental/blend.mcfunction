...
execute as @s[tag=decor_ocean] if score nearby_terrain board_generation matches 4.. \
...
execute as @s[tag=decor_plains] if score nearby_plains board_generation matches 6.. run \
...
execute as @s[tag=decor_mountains] if score nearby_plains board_generation matches 6.. run \
	return run function src:board/generation/terrain/types/setplains
