...
execute if entity @s[tag=ocean,tag=!fish] run return run function structures:build/givebuilder/ocean

execute if entity @s[tag=plains,tag=!fruit,tag=!farm,tag=!village] run return run function structures:build/givebuilder/plains

execute if entity @s[tag=plains,tag=!fruit,tag=farm,tag=!village] run return run function structures:build/givebuilder/farm

execute if entity @s[tag=plains,tag=village] run return run function structures:build/givebuilder/village

execute if entity @s[tag=forest,tag=!hunt] run return run function structures:build/givebuilder/village


execute if entity @s[tag=mountains,tag=mine] run return run function structures:build/givebuilder/mine
